const GLOBAL_INDICES = [
  ...
  { key: "HANGSENG", name: "Hang Seng", symbol: "^HSI", region: "APAC", timeZone: "Asia/Hong_Kong", sessions: [[570, 720], [780, 960]], description: "Tracks the largest and most liquid companies listed in Hong Kong and is an important gauge of Chinese and regional risk appetite." },
  { key: "NIKKEI225", name: "Nikkei 225", symbol: "^N225", region: "APAC", timeZone: "Asia/Tokyo", sessions: [[540, 690], [750, 930]], description: "A price-weighted benchmark of 225 leading companies listed in Japan." },
  { key: "FTSE100", name: "FTSE 100", symbol: "^FTSE", region: "EMEA", timeZone: "Europe/London", sessions: [[480, 990]], description: "Tracks 100 of the largest companies listed on the London Stock Exchange." },
  { key: "DAX", name: "DAX", symbol: "^GDAXI", region: "EMEA", timeZone: "Europe/Berlin", sessions: [[540, 1050]], description: "Tracks 40 major German blue-chip companies listed on the Frankfurt Stock Exchange." },
  { key: "EUROSTOXX50", name: "EURO STOXX 50", symbol: "^STOXX50E", region: "EMEA", timeZone: "Europe/Berlin", sessions: [[540, 1050]], description: "Tracks 50 leading blue-chip companies from euro-area countries." },
