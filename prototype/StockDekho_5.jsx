...
function TooltipPopup({ anchorRect, align = "left", children }) {
  ...
  return (
    <div className="sd-fade-in" style={{
      position: "fixed", zIndex: 500, top, left, width, maxWidth: `calc(100vw - ${margin * 2}px)`,
      ...
      color: THEME.creamDim, boxShadow: "0 10px 28px rgba(0,0,0,0.5)", wordBreak: "break-word", overflowWrap: "break-word",
    }}>
      {children}
    </div>
  );
