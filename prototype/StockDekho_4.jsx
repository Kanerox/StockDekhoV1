...
function IndexCard({ idx, onOpen }) {
  return (
    <div onClick={() => onOpen(idx.key)} className="sd-row-hover" style={{
      ...
      background: THEME.panel, minWidth: 168,
    }}>
      ...
      <div style={{ fontSize: 10, color: THEME.inkDim, marginTop: 4 }}>EOD · {idx.sourceDate}</div>
    </div>
  );
}
...
/* =========================================================================================
   ...
   ========================================================================================= */
function BenchmarkDetailPage({ indexKey, back }) {
...
function RowMetricLabel({ label, infoKey }) {
  ...
  return (
    ...
    >
      ...
      {open && info && (
        <div onClick={(e) => e.stopPropagation()} className="sd-fade-in" style={{
          position: "absolute", zIndex: 30, top: 20, left: 0, width: 230, textAlign: "left", textTransform: "none",
          fontWeight: 400, fontSize: 11.5, lineHeight: 1.45, background: THEME.panelAlt, border: `1px solid ${THEME.hairline}`,
          borderRadius: 5, padding: 10, color: THEME.creamDim, boxShadow: "0 10px 24px rgba(0,0,0,0.4)",
        }}>
          <div style={{ marginBottom: 5 }}><b style={{ color: THEME.gold }}>What: </b>{info.what}</div>
  ...
  return (
    <div className="sd-root" style={{ background: THEME.navy, minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ flex: 1 }}>
        ...
        {page === "benchmark" && <BenchmarkDetailPage indexKey={activeBenchmark} back={() => setPage("markets")} />}
